    ...
    <div className="min-h-screen bg-[#0d0500] flex items-center justify-center p-4">
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-white/80 text-sm">Staff Account Setup</p>
        </div>
        ...
        {loadError ? (
          ...
          <div className="bg-green-950/30 border border-green-500/40 rounded-2xl p-8 text-center">
            ...
            <p className="text-white/80 text-sm mb-6">Your staff account is active. You can now log in.</p>
            <a href="/checkin"
          ...
          <div className="bg-white/[0.04] border border-white/10 rounded-2xl p-6 space-y-5">
            <div>
              ...
              <p className="text-white/80 text-sm">{staffInfo.email}</p>
            </div>
            ...
            <div className="space-y-3">
              <p className="text-white/80 text-sm font-semibold">Set your password</p>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button type="button" onClick={() => setShowPw(!showPw)}
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-white/80 hover:text-white/60 cursor-pointer">
              ...
              <div>
                <label className="text-white/80 text-xs uppercase tracking-wider mb-1.5 block">Confirm Password</label>
                <input
                  type="password"
                  value={confirm}
          ...
          <div className="text-center py-10">
            ...
            <p className="text-white/80 text-sm mt-4">Loading invite...</p>
          </div>
        )}
      </motion.div>
    </div>
