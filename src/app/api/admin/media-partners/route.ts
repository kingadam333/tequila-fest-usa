...
export async function POST(req: NextRequest) {
  ...
  <div style="background:#241503;border:1px solid rgba(245,166,35,0.2);border-radius:16px;padding:28px;margin-bottom:24px">
    ...
    <table style="width:100%;font-size:14px;margin-bottom:20px">
      <tr><td style="color:rgba(255,248,240,0.6);padding:4px 0;width:35%">Login URL</td><td style="color:#fff8f0">${appUrl}/media/login</td></tr>
      <tr><td style="color:rgba(255,248,240,0.6);padding:4px 0">Email</td><td style="color:#fff8f0">${cleanEmail}</td></tr>
      <tr><td style="color:rgba(255,248,240,0.6);padding:4px 0">Password</td><td style="color:#F5A623;font-family:monospace;font-weight:700">${password}</td></tr>
    </table>
  ...
  <p style="color:rgba(255,248,240,0.5);font-size:12px">Questions? Reply to this email.</p>`),
    });
  } catch (err) {
