      ...
      >
        <div className="max-w-7xl mx-auto px-4 h-16 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/#events"
              className="hidden md:inline-flex items-center gap-2 bg-yellow-500 hover:bg-yellow-400 text-black font-bold text-sm px-5 py-2.5 rounded-full transition-all duration-200 hover:scale-105 active:scale-95"
            >
              Get Tickets
            </Link>
